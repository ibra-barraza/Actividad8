...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        series.add(Pelicula("Dr. Who", R.drawable.drwho, R.drawable.drwhoheader, "TTraveling across time and space, the immortal time-lord known as 'The Doctor' travels across the universe with his many companions and his loyal shape-shifting space-ship: The TARDIS. The Doctor faces many threats across many generations: from The Daleks, The Cybermen and his time-lord adversary The Master to the sinister Davros, creator of The Daleks.", arrayListOf<Cliente>()));
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            image.setOnClickListener {
                ...
                intento.putExtra("numberSeats", 20 - pelicula.occupiedSeats.size)
                intento.putExtra("id", position)
                intento.putExtra("occupiedSeats", pelicula.occupiedSeats)
